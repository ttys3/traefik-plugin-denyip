...
cp -v .traefik.yml demo/plugins-local/src/github.com/ttys3/traefik-plugin-denyip/
cp -v plugin.wasm demo/plugins-local/src/github.com/ttys3/traefik-plugin-denyip/